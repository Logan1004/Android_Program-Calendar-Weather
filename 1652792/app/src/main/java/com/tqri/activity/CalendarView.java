...
import com.tqri.calendar.SpecialCalendar;
...
public class CalendarView extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		spannableString.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), 0, d.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		spannableString.setSpan(new RelativeSizeSpan(1.2f) , 0, d.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		if(dv != null || dv != ""){
			spannableString.setSpan(new RelativeSizeSpan(0.75f), d.length()+1, dayNumber[position].length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
		}
	...
	private void getweek(int year, int month) {
		...
		dataBase = new ScheduleDAO(context);
