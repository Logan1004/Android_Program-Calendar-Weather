...
public class ScheduleDAO {
	...
	public ScheduleDAO(Context context){
		...
		dbOpenHelper = new DBOpenHelper(context, "schedules.dataBase");
	}
	...
	public int save(ScheduleVO scheduleVO){
		...
		try{
			...
			Cursor cursor = dataBase.rawQuery("select max(scheduleID) from schedule", null);
	...
	public ScheduleVO getScheduleByID(Context context,int scheduleID){
		//	dbOpenHelper = new DBOpenHelper(context, "schedules.dataBase");
		SQLiteDatabase dataBase = dbOpenHelper.getWritableDatabase();
		Cursor cursor = dataBase.query("schedule", new String[]{"scheduleID","scheduleTypeID","remindID","scheduleContent","scheduleDate","time","alartime"}, "scheduleID=?", new String[]{String.valueOf(scheduleID)}, null, null, null,null);
		if(cursor.moveToFirst()){
	...
	public ArrayList<ScheduleVO> getAllSchedule(){
		...
		//dbOpenHelper = new DBOpenHelper(context, "schedules.dataBase");
		SQLiteDatabase dataBase = dbOpenHelper.getWritableDatabase();
		Cursor cursor = dataBase.query("schedule", new String[]{"scheduleID","scheduleTypeID","remindID","scheduleContent","scheduleDate","time","alartime"}, null, null, null, null, "scheduleID desc",null);
	...
	public void delete(int scheduleID){
		...
		dataBase.beginTransaction();
		try{
			dataBase.delete("schedule", "scheduleID=?", new String[]{String.valueOf(scheduleID)});
	...
	public void update(ScheduleVO vo){
		...
		dataBase.update("schedule", values, "scheduleID=?", new String[]{String.valueOf(vo.getScheduleID())});
		dataBase.close();
	}
